...
var refTest = firebase.database().ref("/Cafeterias/Cafeteria2/Menu/");
...
function eliminar(id){
	...
	firebase.database().ref().child('/Cafeterias/Cafeteria2/Menu/' + id).remove();
...
function editar(id,principio,sobremesa,ensalada,jugo,precio,imagen){
		...
		var washingtonRef =firebase.database().ref().child('/Cafeterias/Cafeteria2/Menu/' + id);
