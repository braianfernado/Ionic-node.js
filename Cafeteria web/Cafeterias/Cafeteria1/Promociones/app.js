...
var refTest = firebase.database().ref("/Cafeterias/Cafeteria1/Promociones/");
...
function eliminar(id){
	...
	firebase.database().ref().child('/Cafeterias/Cafeteria1/Promociones/' + id).remove();
...
function editar(id,comida,bebida,precio,imagen){
		...
		var washingtonRef =firebase.database().ref().child('/Cafeterias/Cafeteria1/Promociones/' + id);
